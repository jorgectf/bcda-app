...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:EpisodeOfCare">
      <sch:assert test="count(f:extension[@url = 'http://alr.cms.gov/ig/StructureDefinition/ext-covidEpisode']) &lt;= 1">extension with URL = 'http://alr.cms.gov/ig/StructureDefinition/ext-covidEpisode': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:team) &lt;= 0">team: maximum cardinality of 'team' is 0</sch:assert>
