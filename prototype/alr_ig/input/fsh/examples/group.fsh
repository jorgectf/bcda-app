...
* member[0].extension[ext-voluntaryAlignmentProvider][0].valueIdentifier.value = "example-TIN"
* member[0].extension[ext-voluntaryAlignmentProvider][0].valueIdentifier.system = "http://terminology.hl7.org/CodeSystem/v2-0203"
* member[0].extension[ext-voluntaryAlignmentProvider][0].valueIdentifier.type.coding.code = #TAX
* member[0].extension[ext-voluntaryAlignmentProvider][0].valueIdentifier.type.coding.display = "Tax ID number"
* member[0].extension[ext-voluntaryAlignmentProvider][0].valueIdentifier.type.coding.system = "http://terminology.hl7.org/CodeSystem/v2-0203"
* member[0].extension[ext-voluntaryAlignmentProvider][1].valueIdentifier.value = "example-NPI"
* member[0].extension[ext-voluntaryAlignmentProvider][1].valueIdentifier.system = "http://hl7.org/fhir/sid/us-npi"
* member[0].extension[ext-voluntaryAlignmentProvider][1].valueIdentifier.type.coding.code = #NPI
* member[0].extension[ext-voluntaryAlignmentProvider][1].valueIdentifier.type.coding.display = "NPI number"
* member[0].extension[ext-voluntaryAlignmentProvider][1].valueIdentifier.type.coding.system = "http://hl7.org/fhir/sid/us-npi"
* member[0].extension[ext-claimsBasedAssignmentFlag].valueBoolean = true
* member[0].extension[ext-claimsBasedAssignmentStep].valueInteger = 1
...
* member[1].extension[ext-claimsBasedAssignmentStep].valueInteger = 0
...
* member[3].extension[ext-claimsBasedAssignmentFlag].valueBoolean = true
* member[3].extension[ext-claimsBasedAssignmentStep].valueInteger = 2
